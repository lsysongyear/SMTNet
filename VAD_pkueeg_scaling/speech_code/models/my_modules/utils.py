...
def modules_from_config(modules: list[tuple[str, dict]]):
    ...
    for module in modules:
        ...
        if module_type == "linear":
        ...
        elif module_type == "brain_magic_speech_v2":
            from speech_code.models.my_modules.BrainNetwork_v2 import Brain_Magic_speech_v2
            module = Brain_Magic_speech_v2(**config)
        elif module_type == "brain_magic_speech_v3":
            from speech_code.models.my_modules.BrainNetwork_v3 import Brain_Magic_speech_v1 as Brain_Magic_speech_v3
            module = Brain_Magic_speech_v3(**config)
        elif module_type == "brain_magic_speech_v4":
            # v4: 仅被试 ID 索引，空间注意力仅 25 层
            module = Brain_Magic_speech_v4(**config)
        elif module_type == "brain_magic_speech_v5":
            from speech_code.models.my_modules.BrainNetwork_v5 import Brain_Magic_speech_v1 as Brain_Magic_speech_v5
            module = Brain_Magic_speech_v5(**config)
        elif module_type == "brain_magic_speech_v6":
            from speech_code.models.my_modules.BrainNetwork_v6 import Brain_Magic_speech_v1 as Brain_Magic_speech_v6
            module = Brain_Magic_speech_v6(**config)
        elif module_type == "brain_magic_speech_v7":
            # v7: v4 的 short_conv_block 改为周期性指数膨胀卷积
            ...
            # EEG Conformer: Conv embedding + Transformer encoder, frame-level VAD
