...
class BrainMagic_NoSubjectAttn(nn.Module):
    def __init__(self, input_dim=306, attention_dim=128, output_dim=1,
                 ...
                 n_subjects=25, dilation_cycle=12):
        super().__init__()
    ...
    def forward(self, x, subject_ids=None):
        ...
        if subject_ids is not None:
            ...
            for i in range(B):
                ...
                attn_outputs.append(self.spatial_attentions[idx](x[i:i+1]))
...
if __name__ == "__main__":
    ...
    for name, Model in [
        ...
        model = Model(input_dim=57, attention_dim=128, kernel_size=25, dropout=0.1).to(device)
